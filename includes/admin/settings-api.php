<?php
// Required for settings API only
...
function rating_login_required_input_cb() {
  ...
  ?>
  <select id="rating_login_required" class="form-control" name="r_opts[rating_login_required]">
    <option value="1">No</option>
    <option value="2"
      <?php echo $recipe_opts['rating_login_required'] == 2 ? 'SELECTED' : '' ?>>Yes
    </option>
  </select>
  <?php
}
...
function recipe_submission_login_required_input_cb() {
  $recipe_opts = get_option( 'r_opts' );
  ?>
  <select id="recipe_submission_login_required" class="form-control" name="r_opts[recipe_submission_login_required]">
    <option value="1">No</option>
    <option value="2"
      <?php echo $recipe_opts['recipe_submission_login_required'] == 2 ? 'SELECTED' : '' ?>>Yes
    </option>
  </select>
  <?php
}
